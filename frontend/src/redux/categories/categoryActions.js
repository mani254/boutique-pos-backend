...
export const addCategory = (categoryData) => {
   return async (dispatch) => {
      ...
      await axios.post(`${process.env.REACT_APP_BACKENDURI}/api/categories`, categoryData).then(res => {
...
export const deleteCategory = (categoryId) => {
   return async (dispatch) => {
      ...
      try {
         await axios.delete(`${process.env.REACT_APP_BACKENDURI}/api/categories/${categoryId}`);

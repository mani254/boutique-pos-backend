...
export const addStore = (storeDetails) => {
   console.log('hello from addStore')
   return async (dispatch) => {
      ...
      try {
         const response = await axios.post(`${process.env.REACT_APP_BACKENDURI}/api/stores`, formData, {
            headers: {
...
export const getStores = () => {
   return async (dispatch) => {
      ...
      try {
         const response = await axios.get(`${process.env.REACT_APP_BACKENDURI}/api/stores`);
...
export const updateStore = (storeDetails) => {
   return async (dispatch) => {
      ...
      try {
         const response = await axios.put(`${process.env.REACT_APP_BACKENDURI}/api/stores/${storeDetails._id}`, formData, {
            headers: {
               'Content-Type': 'multipart/form-data'
            }
         });
...
export const deleteStore = (storeId) => {
   return async (dispatch) => {
      ...
      try {
         const response = await axios.delete(`${process.env.REACT_APP_BACKENDURI}/api/stores/${storeId}`);
...
export const updateStoreStatus = ({ _id, status }) => {
   return async (dispatch) => {
      ...
      try {
         const response = await axios.put(`${process.env.REACT_APP_BACKENDURI}/api/stores/${_id}/status`, { status });

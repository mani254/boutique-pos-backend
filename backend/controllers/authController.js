   ...
   loginAdmin: async (req, res) => {
      try {
         ...
         if (existingAdmin) {
            ...
            if (passwordMatch) {
               let details = { username: existingAdmin.username, _id: existingAdmin._id, email: existingAdmin.email, superAdmin: existingAdmin.superAdmin }
               ...
               return res.status(200).json({ message: "Login successful", token, admin: details });
            }
